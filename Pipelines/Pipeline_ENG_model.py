...
df = pandas.read_csv("D:\\sha\\Daten_BA\\ADV-ELE.csv", sep=";")
...
class SimplificationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        src = self.data.iloc[idx]['Advanced']
        tgt = self.data.iloc[idx]['Elementary']
...
training_args = TrainingArguments(
    output_dir="D:\\sha\\mbart-simplification-eng-de",
